...
#define SETUP_STREAM(v) \
    SQStream *self = NULL; \
    if(SQ_FAILED(sq_getinstanceup(v,1,(SQUserPointer*)&self,SQ_TYPE_TAG_AS_USER_POINTER(SQSTD_STREAM_TYPE_TAG)))) \
...
void init_streamclass(HSQUIRRELVM v)
{
    ...
    if(SQ_FAILED(sq_get(v,-2))) {
        ...
        sq_settypetag(v,-1,SQ_TYPE_TAG_AS_USER_POINTER(SQSTD_STREAM_TYPE_TAG));
        SQInteger i = 0;
